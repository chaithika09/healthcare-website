...
var h="<!DOCTYPE html><html><head><title>MedIQ+ Report</title></head><body style=\"font-family:sans-serif\"><h1>MedIQ+ Test Report</h1><p>Total: "+data.total+" | Passed: "+data.passed+" | Failed: "+data.failed+" | Rate: "+data.passRate+"</p><p>URL: "+BASE_URL+"</p></body></html>";
fs.writeFileSync("reports/html/execution-report.html",h);
fs.writeFileSync("reports/html/dashboard.html",h);
console.log("HTML reports done");